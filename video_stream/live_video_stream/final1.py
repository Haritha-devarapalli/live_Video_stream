#!/usr/bin/env python3
# sim_global.py - Original code, just using EC200 instead of WiFi
...
SIM_INTERFACE = "usb0"   # Changed from wlan0 to usb0 for EC200
...
def index():
    ...
    <p>RTMP: {rtmp_url}</p>
    <p>Tailscale URL: <a href="https://raspberrypi.tail47c22.ts.net:5001">https://raspberrypi.tail47c22.ts.net:5001</a></p>
    <p>Local URL: <a href="http://localhost:5001">http://localhost:5001</a></p>
    '''
...
if __name__ == '__main__':
    ...
    print(f"📡 Tailscale URL: https://raspberrypi.tail47c22.ts.net:5001")
    print(f"📡 Stream URL: https://raspberrypi.tail47c22.ts.net:5001/stream")
    print("="*50 + "\n")
